...
<template>
  ...
  <Dialog :open="qrOpen" :modal="false" @update:open="qrOpen = $event">
    <DialogContent class="rounded-[28px] sm:max-w-2xl">
      ...
      <div class="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
        <div class="rounded-[26px] border border-white/10 bg-[var(--surface-elevated)] p-4">
        ...
        <div class="space-y-4">
          <div class="rounded-[26px] border border-white/10 bg-[var(--surface-elevated)] p-5">
          ...
          <div class="rounded-[26px] border border-dashed border-white/10 bg-[var(--surface-elevated)] p-5">
            <div class="flex items-center gap-2 text-[15px] font-semibold">
  ...
  <Dialog :open="importOpen" :modal="false" @update:open="importOpen = $event">
    <DialogContent class="rounded-[28px] sm:max-w-5xl">
      <DialogHeader>
      ...
      <div class="space-y-5">
        ...
        >
          ...
          <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            <div
              ...
              :key="item.key"
              class="rounded-[26px] border border-white/10 bg-[var(--surface-elevated)] p-5 shadow-[var(--shadow-soft)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[var(--shadow-card)]"
            >
        ...
        <div class="grid gap-4 lg:grid-cols-[1fr_0.9fr]">
          ...
          <div class="rounded-[26px] border border-white/10 bg-[var(--surface-elevated)] p-5 shadow-[var(--shadow-soft)]">
            <div class="flex items-start justify-between gap-3">
